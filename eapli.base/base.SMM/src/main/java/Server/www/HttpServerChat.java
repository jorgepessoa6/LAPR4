...
//            System.exit(1);
//        }
        try { sock = new ServerSocket(30604); }
        catch(IOException ex) {
            System.out.println("Server failed to open local port " + 30604);
            System.exit(1);
        }
        System.out.println("Server ready, listening on port number " + 30604);
